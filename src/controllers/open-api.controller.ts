...
export class OpenApiController {
  constructor(
    @inject('services.OpenApiService')
  ...
  schema: {
    ...
    return this.openAPIService.getByAlpha(codes, fields);
  }
  ...
  schema: {
    ...
    return this.openAPIService.getByAlpha(currency, fields);
  }
  ...
  schema: {
    ...
    return this.openAPIService.getByAlpha(capital, fields);
  }
